...
![スクリーンショットプレースホルダー](https://placehold.co/800x450/png?text=Screenshot)
...
- レベルと王冠（映画登録のたびにポイントが付与されてレベルがUP、季節/年間の視聴本数によって「王冠」獲得）
- RLSによるユーザーごとのデータ保護
...
![インフラ構成図プレースホルダー](https://placehold.co/800x450/png?text=Infrastructure+Diagram)

## ER図

![ER図プレースホルダー](https://placehold.co/800x450/png?text=ER+Diagram)
