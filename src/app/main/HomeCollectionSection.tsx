          ...
          <>
            <div className="flex items-center justify-between mb-1.5">
              <div>
                ...
                <p className="text-neutral-300 text-base mt-0.5">
                  {collection.collectedCount} / {collection.movies.length} 作品収集
                </p>
              </div>
              <span className="text-amber-400 text-xl font-bold">{progress}%</span>
            </div>
            ...
            <div className="flex justify-center gap-x-1.5 sm:gap-x-2 w-full">
              {collection.movies.slice(0, 5).map((movie) => (
                <div
                  key={movie.tmdb_id}
                  className="relative shrink-0 w-[48px] h-[64px] sm:w-[56px] sm:h-[72px] md:w-[64px] md:h-[80px] lg:w-[80px] lg:h-[120px] rounded overflow-hidden border border-amber-900/30 bg-zinc-800"
                >
